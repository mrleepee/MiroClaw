  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MIROCLAW</div>
      </div>
...
// Get maxRounds from query params at initialization to ensure child component gets value immediately
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        addLog('Failed to close environment gracefully, attempting force stop...')
        try {
...
const handleNextStep = () => {
  ...
  // This method serves as a backup
