<template>
  <div class="process-page">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">MIROCLAW</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes content and automatically generates ontology structure (entity types + relation types) suitable for social simulation
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on generated ontology, documents are chunked and processed via Neo4j to build knowledge graph, extracting entities and relationships
                </div>
              </div>
...
const goToNextStep = () => {
  ...
  alert('Environment setup functionality under development...')
}
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files. Please return to home and try again'
    loading.value = false
    return
  }
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling ongoing build task
...
const renderGraph = () => {
  ...
  // Draw edges (include clickable transparent wide lines)
  ...
  // Close detail panel when clicking blank area
  svg.on('click', () => {
    closeDetailPanel()
  })
  
  simulation.on('tick', () => {
    // Update positions of all edges (including visible and transparent click areas)
