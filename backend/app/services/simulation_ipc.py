"""
IPC communication module for simulation
...
logger = get_logger('miroclaw.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        """
        Send an interview command for a single Agent
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: In dual-platform simulations, interview both platforms simultaneously; in single-platform simulations, interview that platform
            timeout: Timeout
            
        Returns:
            IPCResponse, with the interview result in the result field
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            interviews: List of interviews, where each element contains {"agent_id": int, "prompt": str, "platform": str(optional)}
            platform: Default platform (optional, overridden by each interview item's platform)
                - "twitter": By default, interview only on Twitter
                - "reddit": By default, interview only on Reddit
                - None: In dual-platform simulations, each Agent is interviewed on both platforms simultaneously
            timeout: Timeout
