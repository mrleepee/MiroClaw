...
Manage parallel simulation across Twitter and Reddit
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use an LLM to intelligently generate simulation configuration parameters (time, activity level, posting frequency, etc.)
        4. Save configuration files and profile files
        5. Copy the preset scripts to the simulation directory
        ...
        Args:
            ...
            parallel_profile_count: Number of personas to generate in parallel, default is 3
        ...
        try:
            ...
            filtered = reader.filter_defined_entities(
                ...
                actors_only=True,  # Only actor entities become simulation agents
            )
            ...
            if progress_callback:
                progress_callback(
                    "reading", 100, 
                    f"Completed, {filtered.filtered_count} entities in total",
            ...
            # Set the real-time output path (prefer Reddit JSON format)
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"Completed, {len(profiles)} profiles in total",
            ...
            # Note: Run scripts remain in the backend/scripts/ directory and are no longer copied into the simulation directory
            # When starting the simulation, simulation_runner will execute scripts from the scripts/ directory
